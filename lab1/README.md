...
![Figure 1: Oscilloscope Grid Diagram](Oscilloscope_Coordinate_plane.png)
...
![Figure 2: Block Diagram](Oscilloscope%20Grid%20Diagram.png)
...
![Figure 3: hsync signal transitions (high, low, high) in relation to column count.](figure3.png)
_Figure 3: hsync signal transitions (high, low, high) in relation to column count._

![Figure 4: vsync signal transitions (high, low, high) in relation to both row and column count.](figure4.png)
_Figure 4: vsync signal transitions (high, low, high) in relation to both row and column count._

![Figure 5: blank signal transitions (high, low, high) in relation to column and row count.](figure5.png)
_Figure 5: blank signal transitions (high, low, high) in relation to column and row count._

![Figure 6: column count rolling over causing the row count to increment and max counts for both counters](figure6.png)
...
![Figure 7: Gate Check 2 Passing all Cases](figure7.png)
_Figure 7: Gate Check 2 Passing all Cases_

![Figure 8: Successful Online VGA Simulator Display (vga_log_tb for color_mapper file)](figure8.png)
